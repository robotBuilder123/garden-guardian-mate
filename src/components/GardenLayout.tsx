                    ...
                    <div className="text-xs text-muted-foreground mb-2">
                      {totalUsedSpace.toFixed(1)}/{totalSpace.toFixed(1)}m²
                       ...
                       {bedPlants.map(({ plant, x, y }) => (
                         <div
                           key={plant.id}
                            className={`absolute text-white text-xs p-2 w-12 h-12 rounded cursor-move select-none border border-white hover:shadow-lg transition-all duration-200 touch-manipulation flex items-center justify-center ${
                              selectedPlant === plant.id 
